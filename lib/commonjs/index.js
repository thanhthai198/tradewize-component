...
Object.defineProperty(exports, "ImageDrawingCanvas", {
  enumerable: true,
  get: function () {
    return _ImageDrawingCanvas.default;
  }
});
...
Object.keys(_getAllowedPhotos).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _getAllowedPhotos[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _getAllowedPhotos[key];
    }
  });
});
