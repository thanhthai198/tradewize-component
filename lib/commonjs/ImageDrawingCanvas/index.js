...
const ImageDrawingCanvas = props => {
  ...
  (0, _react.useEffect)(() => {
    ...
    const showSub = _reactNative.Keyboard.addListener('keyboardDidShow', onKeyboardShow);
    const hideSub = _reactNative.Keyboard.addListener('keyboardDidHide', onKeyboardHide);
    return () => {
      showSub.remove();
      hideSub.remove();
    };
  ...
  const renderFooterControls = (0, _react.useMemo)(() => {
    if (mode === 'draw') {
      return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
        ...
        key: color,
        style: [_styles.styles.btnColor, colorDraw === color && _styles.styles.colorSelected]
    ...
    if (mode === 'text') {
      return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
        ...
        key: color,
        style: [_styles.styles.btnColor, colorText === color && _styles.styles.colorSelected]
      }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
        style: [_styles.styles.colorDot, {
          backgroundColor: color
        }]
