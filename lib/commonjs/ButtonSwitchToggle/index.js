...
const useSwitchToggle = (value, onValueChange, disabled = false, loading = false, hapticFeedback = false, hapticType = 'light') => {
  ...
  const triggerHaptic = (0, _react.useCallback)(() => {
    if (hapticFeedback) {
      switch (hapticType) {
        case 'light':
          ...
          break;
        case 'medium':
          _reactNative.Vibration.vibrate(50);
          break;
        case 'heavy':
...
const ButtonSwitchToggle = ({
  ...
  const translateX = (0, _react.useRef)(new _reactNative.Animated.Value(currentValue ? maxTranslateX : 0)).current;

  // Animate to position with improved animation
  const animateToPosition = (0, _react.useCallback)((toValue, callback) => {
  ...
  const switchStyle = (0, _react.useMemo)(() => [styles.switch, {
    width: switchWidth,
    height: switchHeight,
    backgroundColor,
  ...
  }, ...(style ? [style] : [])], [switchWidth, switchHeight, backgroundColor, shadow, shadowColor, shadowOffset, shadowOpacity, shadowRadius, style]);
  const thumbStyle = (0, _react.useMemo)(() => [styles.thumb, {
    width: thumbDiameter,
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    activeOpacity: 0.8,
    style: switchStyle
  }, accessibilityProps), customTrack || /*#__PURE__*/_react.default.createElement(_reactNative.Animated.View, {
    style: thumbStyle
  }, customThumb)));
};
...
var _default = exports.default = ButtonSwitchToggle;
