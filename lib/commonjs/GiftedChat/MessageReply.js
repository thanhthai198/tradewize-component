...
const MessageReply = ({
  ...
  }), !(messageReply !== null && messageReply !== void 0 && messageReply.text) && /*#__PURE__*/_reactNative.default.createElement(_reactNative.View, {
    style: styles.space
  }), (messageReply === null || messageReply === void 0 ? void 0 : messageReply.text) && /*#__PURE__*/_reactNative.default.createElement(_MessageText.MessageText, {
    currentMessage: messageReply,
    position: "left",
    customTextStyle: {
