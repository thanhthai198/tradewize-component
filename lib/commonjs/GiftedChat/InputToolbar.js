...
function InputToolbar(props) {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      return /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
        ...
        style: [styles.previewFileItem, {
          width: (0, _utils.getScreenWidth)() * 0.22,
          height: (0, _utils.getScreenWidth)() * 0.22
        }]
        ...
        style: [styles.removeFile, {
          width: (0, _utils.getScreenWidth)() * 0.06,
          height: (0, _utils.getScreenWidth)() * 0.06
        }]
        ...
        style: [styles.iconPlayContainer, {
          width: (0, _utils.getScreenWidth)() * 0.1,
          height: (0, _utils.getScreenWidth)() * 0.1,
          top: (0, _utils.getScreenWidth)() * 0.22 / 2 - (0, _utils.getScreenWidth)() * 0.1 / 2,
          right: (0, _utils.getScreenWidth)() * 0.22 / 2 - (0, _utils.getScreenWidth)() * 0.1 / 2
        }]
      ...
      }, (0, _utils2.formatDurationSmart)((item === null || item === void 0 ? void 0 : item.duration) || 0))));
    }));
  ...
  }, labelReaction), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    numberOfLines: 2,
    style: styles.messageReactionContent
  }, messageReaction.text)), /*#__PURE__*/_react.default.createElement(_ButtonBase.ButtonBase, {
    activeOpacity: 0.7,
    variant: "ghost",
    title: "X",
    onPress: () => {
...
const styles = _reactNative.StyleSheet.create({
  ...
  messageReactionCloseButton: {
    width: (0, _utils.getScreenWidth)() * 0.07,
    height: (0, _utils.getScreenWidth)() * 0.07,
    justifyContent: 'center',
    alignItems: 'flex-end'
  }
});
