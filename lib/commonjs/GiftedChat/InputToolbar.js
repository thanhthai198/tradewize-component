...
function InputToolbar(props) {
  ...
  const renderFileMedia = (0, _react.useMemo)(() => {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNativeReanimated.default.View, {
      ...
      entering: _reactNativeReanimated.SlideInDown.duration(300).springify(),
      exiting: _reactNativeReanimated.SlideOutUp.duration(300).springify(),
      layout: _reactNativeReanimated.Layout.springify()
    }, fileMedia === null || fileMedia === void 0 ? void 0 : fileMedia.map((item, index) => {
      return /*#__PURE__*/_react.default.createElement(_reactNativeReanimated.default.View, {
        key: item.id,
        entering: _reactNativeReanimated.SlideInDown.delay(index * 100).duration(300).springify(),
        exiting: _reactNativeReanimated.SlideOutUp.duration(300).springify(),
        layout: _reactNativeReanimated.Layout.springify()
