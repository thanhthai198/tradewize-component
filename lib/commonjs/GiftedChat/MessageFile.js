...
const MediaItem = /*#__PURE__*/(0, _react.memo)(({
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_ButtonBase.ButtonBase, {
  ...
  (0, _react.useEffect)(() => {
    const fetchData = async () => {
      try {
        ...
        const result = await (0, _utils.generateThumbnails)(arrVideo);
