...
function MessageFile({
  ...
  const MediaItem = (0, _react.useCallback)(({
    ...
    }, /*#__PURE__*/React.createElement(_reactNativeFastImage.default, {
      source: {
        uri: item.thumbnailPreview || item.uri
      },
      style: styles.image
    }), (item === null || item === void 0 ? void 0 : item.typeFile) === 'video' && /*#__PURE__*/React.createElement(_reactNative.View, {
      style: [styles.playIcon, {
        width: sizeMedia * 0.5,
        height: sizeMedia * 0.5,
        borderRadius: sizeMedia * 0.5 / 2
      }]
    }, item !== null && item !== void 0 && item.isLoading ? /*#__PURE__*/React.createElement(_reactNative.ActivityIndicator, {
      size: "small",
    ...
    })), (arrMedia === null || arrMedia === void 0 ? void 0 : arrMedia.length) > 8 && index === 7 && !isShowAll && /*#__PURE__*/React.createElement(_reactNative.View, {
