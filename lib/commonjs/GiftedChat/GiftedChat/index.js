...
var _ImageDrawingCanvas = _interopRequireDefault(require("../../ImageDrawingCanvas"));
...
function GiftedChat(props) {
  ...
  const [fileMediaEdit, setFileMediaEdit] = (0, _react.useState)(false);
  const [fileMediaEditLocal, setFileMediaEditLocal] = (0, _react.useState)(null);
  ...
  }), /*#__PURE__*/_react.default.createElement(_ImageDrawingCanvas.default, {
    visible: fileMediaEdit,
    uriImage: (fileMediaEditLocal === null || fileMediaEditLocal === void 0 ? void 0 : fileMediaEditLocal.uri) || '',
    onClose: () => setFileMediaEdit(false),
    onSave: uri => {
      setFileMedia(prev => {
        const newFileMedia = prev.map(item => {
          if (item.id === (fileMediaEditLocal === null || fileMediaEditLocal === void 0 ? void 0 : fileMediaEditLocal.id)) {
            return {
              ...item,
              uri: uri,
              thumbnailPreview: uri
