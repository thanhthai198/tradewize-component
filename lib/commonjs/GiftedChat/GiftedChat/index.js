...
function GiftedChat(props) {
  ...
  }, [isInitialized, isTyping, arrMessage, props, inverted, keyboardShouldPersistTaps, messageContainerRef, renderChatFooter, handlePressFile]);
  ...
  }, [isInitialized, _onSend, getTextFromProp, maxInputLength, minComposerHeight, onInputSizeChanged, props, text, renderInputToolbar, composerHeight, isTypingDisabled, textInputRef, textInputProps, _onInputTextChanged, onPressPickMedia, fileMedia, handlePressFile, messageReaction, labelReaction]);
  const handleReactionEmoji = (0, _react.useCallback)((emoji, messageId) => {
    const newArrMessage = arrMessage === null || arrMessage === void 0 ? void 0 : arrMessage.map(item => {
      var _item$_id;
      if ((item === null || item === void 0 || (_item$_id = item._id) === null || _item$_id === void 0 ? void 0 : _item$_id.toString()) === messageId) {
        return {
          ...item,
          reactionEmoji: emoji
        };
  ...
  }, renderMessages, inputToolbarFragment, /*#__PURE__*/_react.default.createElement(_reactNativeImageViewing.default, {
    images: fileSelected ? [{
  ...
  }), /*#__PURE__*/_react.default.createElement(_VideoPlayer.VideoModal, {
