...
function GiftedChat(props) {
  ...
  const renderMessages = (0, _react.useMemo)(() => {
    ...
    }, /*#__PURE__*/React.createElement(_MessageContainer.default, _extends({}, messagesContainerProps, {
  ...
  const _onSend = (0, _react.useCallback)((messages = [], shouldResetInputToolbar = false) => {
  ...
  const onPressPickMedia = (0, _react.useCallback)(async type => {
    if (type === 'camera') {
      ...
      const fileMediaAll = result === null || result === void 0 ? void 0 : result.map(item => {
        const uri = _reactNative.Platform.OS === 'android' ? `file://${item.path}` : item.sourceURL;
        return {
          uri: uri,
  ...
  const inputToolbarFragment = (0, _react.useMemo)(() => {
    ...
    return /*#__PURE__*/React.createElement(_InputToolbar.InputToolbar, _extends({
      onRemoveFile: file => {
  ...
  return /*#__PURE__*/React.createElement(_GiftedChatContext.GiftedChatContext.Provider, {
    value: contextValues
  }, /*#__PURE__*/React.createElement(_reactNativeActionSheet.ActionSheetProvider, {
    ref: actionSheetRef
  }, /*#__PURE__*/React.createElement(_reactNative.View, {
    testID: _Constant.TEST_ID.WRAPPER,
    style: [_styles.default.fill, _styles2.default.contentContainer],
    onLayout: onInitialLayoutViewLayout
  }, isInitialized ? /*#__PURE__*/React.createElement(_reactNativeReanimated.default.View, {
    style: [_styles.default.fill, isKeyboardInternallyHandled && contentStyleAnim]
  }, renderMessages, inputToolbarFragment, /*#__PURE__*/React.createElement(_reactNativeImageViewing.default, {
    images: fileSelected ? [{
  ...
  }), /*#__PURE__*/React.createElement(_VideoPlayer.VideoModal, {
    ...
    autoPlay: true
  }), /*#__PURE__*/React.createElement(_MessageWithReaction.MessageWithReaction, {
    user: user,
  ...
  }), /*#__PURE__*/React.createElement(_MediaAllShow.MediaAllShow, {
  ...
  }), /*#__PURE__*/React.createElement(_Camera.CameraModal, {
...
function GiftedChatWrapper(props) {
  return /*#__PURE__*/React.createElement(_reactNativeKeyboardController.KeyboardProvider, null, /*#__PURE__*/React.createElement(GiftedChat, props));
}
