...
const MessageWithReaction = ({
  ...
  })), isShowEmoji && (user === null || user === void 0 ? void 0 : user._id) !== (message === null || message === void 0 || (_message$user2 = message.user) === null || _message$user2 === void 0 ? void 0 : _message$user2._id) && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
