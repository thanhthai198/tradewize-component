...
const MessageWithReaction = ({
  ...
  const renderMessage = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_MessageText.MessageText, {
    currentMessage: message,
    position: "left"
  }), [message]);
  const renderFile = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_MessageFile.MessageFile, {
    isReaction: true,
    currentMessage: message,
    messageWidth: {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNativeModal.default, {
    ...
    style: styles.btnActionText
  }, "Other"), /*#__PURE__*/_react.default.createElement(_reactNativeFastImage.default, {
    style: styles.icon,
