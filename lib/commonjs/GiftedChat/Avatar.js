...
function Avatar(props) {
  ...
  const renderAvatarComponent = (0, _react.useCallback)(() => {
    ...
    if (currentMessage) return /*#__PURE__*/_react.default.createElement(_GiftedAvatar.GiftedAvatar, {
  ...
  if (!showAvatarForEveryMessage && currentMessage && messageToCompare && (0, _utils.isSameUser)(currentMessage, messageToCompare) && (0, _utils.isSameDay)(currentMessage, messageToCompare)) return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: [styles[position].container, containerStyle === null || containerStyle === void 0 ? void 0 : containerStyle[position]]
  }, /*#__PURE__*/_react.default.createElement(_GiftedAvatar.GiftedAvatar, {
    avatarStyle: [styles[position].image, imageStyle === null || imageStyle === void 0 ? void 0 : imageStyle[position]]
  }));
