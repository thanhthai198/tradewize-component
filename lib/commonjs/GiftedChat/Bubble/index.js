...
const Bubble = props => {
  ...
  const renderBubbleContent = (0, _react.useCallback)(() => {
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, null, !props.isCustomViewBottom && renderCustomView(), renderMessageFile(), renderMessageAudio(), renderMessageText(), props.isCustomViewBottom && renderCustomView());
