...
const SnapScrollView = props => {
  ...
  const renderButton = (0, _react.useMemo)(() => {
    if (mode === 'both') {
      return /*#__PURE__*/React.createElement(React.Fragment, null, activeIndex === 0 ? /*#__PURE__*/React.createElement(_ButtonBase.ButtonBase, {
        style: [styles.captureButton, isCapturing && styles.captureButtonDisabled],
        onPress: capturePhoto,
        disabled: isCapturing
      }, /*#__PURE__*/React.createElement(_reactNative.View, {
        style: styles.captureButtonInner
      })) : /*#__PURE__*/React.createElement(_ButtonContainerVideo.ButtonContainerVideo, {
        isPaused: isPaused,
      ...
      return /*#__PURE__*/React.createElement(_ButtonBase.ButtonBase, {
        style: [styles.captureButton, isCapturing && styles.captureButtonDisabled],
        onPress: capturePhoto,
        disabled: isCapturing
      }, /*#__PURE__*/React.createElement(_reactNative.View, {
      ...
      return /*#__PURE__*/React.createElement(_ButtonContainerVideo.ButtonContainerVideo, {
        isPaused: isPaused,
        isRecording: isRecording,
        pauseRecording: pauseRecording,
        resumeRecording: resumeRecording,
  ...
  return /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    renderItem: ({
      ...
      style: styles.item
    }, !isRecording ? /*#__PURE__*/React.createElement(_reactNative.Text, {
  ...
  }, renderButton), /*#__PURE__*/React.createElement(_reactNative.View, {
...
const styles = _reactNative.StyleSheet.create({
  bottomControls: {
    ...
    zIndex: 1,
    paddingTop: 16,
    height: (0, _utils.getScreenHeight)() * 0.2
  },
  item: {
    width: ITEM_WIDTH,
