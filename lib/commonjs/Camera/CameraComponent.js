...
const CameraComponent = ({
  ...
  const [canStopRecording, setCanStopRecording] = (0, _react.useState)(false); // Kiểm tra có thể dừng quay không
  const [isExportingVideo, setIsExportingVideo] = (0, _react.useState)(false); // Loading khi xuất video
  ...
  const stopRecording = (0, _react.useCallback)(async () => {
    ...
    if (recordingDuration < minRecordingTime) {
      onError === null || onError === void 0 || onError(`Video must be at least ${minRecordingTime} seconds long`);
      return;
    }
    try {
  ...
  const startRecording = (0, _react.useCallback)(async () => {
      ...
      await camera.current.startRecording({
        ...
        onRecordingFinished: async video => {
          ...
          try {
            ...
            onError === null || onError === void 0 || onError('Failed to process video file');
          } finally {
    ...
    setIsPaused(false);
  }, [camera, isRecording, currentFlashMode, onVideoRecorded, onError, isCanPause]);
  ...
  if (!hasPermission || isRequestingPermissions) {
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      style: styles.permissionText
    }, "Camera permission is required"), /*#__PURE__*/_react.default.createElement(_ButtonBase.ButtonBase, {
  ...
  const height = isRecording ? (0, _utils.getScreenHeight)() : (0, _utils.getScreenHeight)() * 0.8;
  ...
  }, formatDuration(recordingDuration), " ", isPaused ? '(Paused)' : '', !hasAudioPermission && audio ? '(No Audio)' : ''), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: styles.timeLimitText
  }, "Max: ", maxRecordingTime, "s")), isExportingVideo && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.exportingIndicator
  }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.exportingDot
  }), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: styles.exportingText
  }, "Exporting video...")));
};
...
const styles = _reactNative.StyleSheet.create({
  ...
  zoomSliderContainer: {
    position: 'absolute',
    bottom: (0, _utils.getScreenHeight)() * 0.2 + 8,
    left: 20,
    right: 20,
    alignItems: 'center',
    zIndex: 1
