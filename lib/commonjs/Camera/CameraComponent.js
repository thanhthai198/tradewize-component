...
const CameraComponent = ({
  ...
  const capturePhoto = (0, _react.useCallback)(async () => {
    ...
    try {
      ...
      onPhotoCaptured === null || onPhotoCaptured === void 0 || onPhotoCaptured(photo);
    } catch (error) {
    ...
    try {
      ...
      await camera.current.startRecording({
        onRecordingFinished: video => {
          onVideoRecorded === null || onVideoRecorded === void 0 || onVideoRecorded(video);
  ...
  }), showAudioWarning && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
