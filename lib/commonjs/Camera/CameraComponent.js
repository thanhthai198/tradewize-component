...
const CameraComponent = ({
  ...
  (0, _react.useEffect)(() => {
    return () => {
      if (camera !== null && camera !== void 0 && camera.current) {
        try {
          // Nếu đang quay thì dừng lại
          if (isRecording) {
            var _camera$current;
            // eslint-disable-next-line react-hooks/exhaustive-deps
            camera === null || camera === void 0 || (_camera$current = camera.current) === null || _camera$current === void 0 || _camera$current.stopRecording();
          }
        } catch (e) {
          console.error(e);
        }
    ...
    try {
      ...
      await camera.current.startRecording({
        ...
        onRecordingFinished: async video => {
          try {
            onExportLoading === null || onExportLoading === void 0 || onExportLoading(true);
            ...
            onExportLoading === null || onExportLoading === void 0 || onExportLoading(false);
            setIsRecording(false);
            setCanStopRecording(false);
            if (isCanPause) {
              setIsPaused(false);
  ...
  const height = (0, _utils.getScreenHeight)();
