...
export * from './types';
const Bubble = props => {
  var _props$user2, _currentMessage$react3;
  const {
    currentMessage,
    nextMessage,
    position,
  ...
  const renderReactionEmoji = useCallback(() => {
    var _props$user, _currentMessage$react;
    ...
    const reactionEmoji = [...new Set(currentMessage === null || currentMessage === void 0 || (_currentMessage$react = currentMessage.reactionEmoji) === null || _currentMessage$react === void 0 ? void 0 : _currentMessage$react.map(item => item === null || item === void 0 ? void 0 : item.reaction))];
    if (reactionEmoji && (reactionEmoji === null || reactionEmoji === void 0 ? void 0 : reactionEmoji.length) > 0) {
      var _currentMessage$react2;
      return /*#__PURE__*/React.createElement(View, {
        style: [{
      ...
      }, currentMessage === null || currentMessage === void 0 || (_currentMessage$react2 = currentMessage.reactionEmoji) === null || _currentMessage$react2 === void 0 ? void 0 : _currentMessage$react2.length));
    }
    return null;
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    style: [styles[position].bottom, bottomContainerStyle === null || bottomContainerStyle === void 0 ? void 0 : bottomContainerStyle[position], (currentMessage === null || currentMessage === void 0 ? void 0 : currentMessage.reactionEmoji) && (currentMessage === null || currentMessage === void 0 || (_currentMessage$react3 = currentMessage.reactionEmoji) === null || _currentMessage$react3 === void 0 ? void 0 : _currentMessage$react3.length) > 0 && {
      marginBottom: 8
    }]
