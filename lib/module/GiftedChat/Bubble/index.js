...
const Bubble = props => {
  ...
  const renderBubbleContent = useCallback(() => {
    return /*#__PURE__*/React.createElement(View, null, !props.isCustomViewBottom && renderCustomView(), renderMessageFile(), renderMessageAudio(), renderMessageText(), props.isCustomViewBottom && renderCustomView());
