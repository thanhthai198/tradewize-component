...
export function MessageFile({
  ...
  const MediaItem = useCallback(({
    ...
    }, "+ ", (arrMedia === null || arrMedia === void 0 ? void 0 : arrMedia.length) - 8 > 99 ? '99+' : (arrMedia === null || arrMedia === void 0 ? void 0 : arrMedia.length) - 8))), !(item !== null && item !== void 0 && item.isLoading) && (item === null || item === void 0 ? void 0 : item.progress) && (item === null || item === void 0 ? void 0 : item.progress) < 100 && /*#__PURE__*/React.createElement(View, {
