...
export function MessageFile({
  ...
  const MediaItem = useCallback(({
    ...
    const size = isShowAll ? sizeMediaShowAll : sizeMedia < getScreenWidth() * 0.1 ? getScreenWidth() * 0.15 : sizeMedia;
    ...
    return /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(ButtonBase, {
    ...
    }) : /*#__PURE__*/React.createElement(React.Fragment, null, (!safeProgress || safeProgress >= 100) && /*#__PURE__*/React.createElement(FastImage, {
    ...
    }, "+ ", (arrMedia === null || arrMedia === void 0 ? void 0 : arrMedia.length) - 8 > 99 ? '99+' : (arrMedia === null || arrMedia === void 0 ? void 0 : arrMedia.length) - 8))), !(item !== null && item !== void 0 && item.isLoading) && safeProgress && safeProgress < 100 && /*#__PURE__*/React.createElement(View, {
