...
export function MessageFile({
  ...
  const MediaItem = useCallback(({
    ...
    }) : /*#__PURE__*/React.createElement(React.Fragment, null, (safeProgress <= 0 || safeProgress >= 100) && /*#__PURE__*/React.createElement(FastImage
  ...
  }, [messageWidth, onPressFile, isReaction, arrMedia, currentMessage, isShowAll, onLongPressFile]);
