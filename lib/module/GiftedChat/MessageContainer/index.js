...
function MessageContainer(props) {
  ...
  const renderTypingIndicator = useCallback(() => {
    ...
    if (isTyping) return /*#__PURE__*/React.createElement(TypingIndicator, null);
    return null;
  ...
  const scrollHandlerForScrollView = event => {
  ...
  }), inverted ? ListFooterComponent : ListHeaderComponent) : /*#__PURE__*/React.createElement(AnimatedFlatList, _extends({
    extraData: extraData,
    ref: forwardRef,
