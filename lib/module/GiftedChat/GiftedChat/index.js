...
function GiftedChat(props) {
  ...
  const [fileMediaEdit, setFileMediaEdit] = useState(false);
  const [fileMediaEditLocal, setFileMediaEditLocal] = useState(null);
  ...
  }), /*#__PURE__*/React.createElement(ImageDrawingCanvas, {
