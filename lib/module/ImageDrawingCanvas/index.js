...
import { Alert, Animated, Dimensions, Image, Keyboard, Modal, PanResponder, Platform, ScrollView, Text, TextInput, TouchableOpacity, View } from 'react-native';
  ...
  const renderFooterControls = useMemo(() => {
    if (mode === 'draw') {
      return /*#__PURE__*/React.createElement(View, {
        ...
        key: color,
        style: [styles.btnColor, colorDraw === color && styles.colorSelected]
    ...
    if (mode === 'text') {
      return /*#__PURE__*/React.createElement(View, {
        ...
        key: color,
        style: [styles.btnColor, colorText === color && styles.colorSelected]
      }, /*#__PURE__*/React.createElement(View, {
        style: [styles.colorDot, {
          backgroundColor: color
        }]
    ...
    return /*#__PURE__*/React.createElement(View, {
      style: styles.footerDraw
    }, hasDrawing && /*#__PURE__*/React.createElement(TouchableOpacity, {
