...
import { View, StyleSheet, Animated, TouchableOpacity, Vibration } from 'react-native';
...
const ButtonSwitchToggle = ({
  ...
  const switchStyle = useMemo(() => [styles.switch, {
    width: switchWidth,
    height: switchHeight,
    backgroundColor,
  ...
  const thumbStyle = useMemo(() => [styles.thumb, {
    width: thumbDiameter,
