...
const FanMenu = ({
  ...
  useEffect(() => {
    if (visible) {
      ...
      const itemAnimations = itemAnims.map((anim, index) => Animated.spring(anim, {
        toValue: 1,
        tension: 100,
        friction: 8,
        delay: index * 80,
  ...
  const getItemPosition = index => {
    ...
    if (isPlusEdgeDistance) {
      ...
      ry = position.y + (mainButtonSize + minEdgeDistance * 0.3) / 2 + mainButtonSize * 1.5;
    }
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    return /*#__PURE__*/React.createElement(Animated.View, {
      ...
      activeOpacity: 0.8
    }, item !== null && item !== void 0 && item.renderIcon ? item === null || item === void 0 ? void 0 : item.renderIcon : /*#__PURE__*/React.createElement(Image, {
