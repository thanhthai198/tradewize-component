...
export const CheckBox = ({
  ...
  const debouncedOnPress = useMemo(() => debounce(event => {
    if (onPress) {
      onPress(event);
    }
    if (onValueChange) {
  ...
  const renderCheckIcon = () => {
    ...
    if (indeterminate) {
      return customIndeterminateIcon || /*#__PURE__*/React.createElement(View
    ...
    if (checked) {
      return customCheckIcon || /*#__PURE__*/React.createElement(Text, {
