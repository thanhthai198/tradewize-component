...
import { View, Text, TouchableOpacity, StyleSheet, Alert, Image, Platform, Modal, FlatList, Dimensions } from 'react-native';
...
const ImagePickerComponent = ({
    ...
    try {
      if (Platform.OS === 'android') {
        if (Platform.Version >= 33) {
          ...
          const results = await requestMultiple([PERMISSIONS.ANDROID.READ_MEDIA_IMAGES, PERMISSIONS.ANDROID.READ_MEDIA_VIDEO]);
          const grantedImages = results[PERMISSIONS.ANDROID.READ_MEDIA_IMAGES] === RESULTS.GRANTED;
          const grantedVideos = results[PERMISSIONS.ANDROID.READ_MEDIA_VIDEO] === RESULTS.GRANTED;
  ...
  const renderLimitedPhotoItem = useCallback(({
    ...
    }, "\u2713"))), (item === null || item === void 0 ? void 0 : item.mediaType) === 'video' && /*#__PURE__*/React.createElement(View, {
  ...
  }, multiple ? `${titleModal} (${selectedLimitedPhotos.size}/${maxFiles})` : titleModal), /*#__PURE__*/React.createElement(TouchableOpacity, {
