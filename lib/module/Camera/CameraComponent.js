...
export const CameraComponent = ({
  ...
  const [isExportingVideo, setIsExportingVideo] = useState(false); // Loading khi xuất video
  ...
  if (!hasPermission || isRequestingPermissions) {
    ...
    }, "Requesting permissions...")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Text, {
      style: styles.permissionText
  ...
  }), showAudioWarning && !hasAudioPermission && /*#__PURE__*/React.createElement(View, {
  ...
  }, formatDuration(recordingDuration), " ", isPaused ? '(Paused)' : '', !hasAudioPermission && audio ? '(No Audio)' : ''), /*#__PURE__*/React.createElement(Text, {
    style: styles.timeLimitText
  }, "Max: ", maxRecordingTime, "s")), isExportingVideo && /*#__PURE__*/React.createElement(View, {
